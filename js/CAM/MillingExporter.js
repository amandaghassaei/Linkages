...
//        });
    ...
    _makeTriangle: function(hinges, indices, isSolid, drawOffset){
        var self = this;
        _.each(indices, function(num){//through holes
        ...
        var outline = this._makeOutlinePath(hinges, indices, globals.appState.get("linkWidth")/2.0*this.get("scalingFactor"), drawOffset);
