...
MutationMenuView = Backbone.View.extend({
    ...
    template: _.template('\
        ...
        Simulated Annealing <a class="helpModal" data-type="simulatedAnnealing" href="#"><img class="helpIcon" src="../../assets/ui/helpIcon.png"/></a></label><br/>\
        <% if (simulatedAnnealing){ %>\
        Mutation Rate (%): &nbsp;&nbsp;<input data-type="saMaxMutationRate" value="<%= saMaxMutationRate %>" placeholder="Mutation Rate" class="form-control numberInput" type="text">&nbsp;&nbsp;to&nbsp;&nbsp;<input data-type="saMinMutationRate" value="<%= saMinMutationRate %>" placeholder="Mutation Rate" class="form-control numberInput" type="text"> <a class="helpModal" data-type="mutationRate" href="#"><img class="helpIcon" src="../../assets/ui/helpIcon.png"/></a><br/><br/>\
        Max Length Change (%): &nbsp;&nbsp;<input data-type="saMaxLinkChange" value="<%= saMaxLinkChange %>" placeholder="Max Change" class="form-control numberInput" type="text">&nbsp;&nbsp;to&nbsp;&nbsp;<input data-type="saMinLinkChange" value="<%= saMinLinkChange %>" placeholder="Max Change" class="form-control numberInput" type="text">  <a class="helpModal" data-type="maxLengthChange" href="#"><img class="helpIcon" src="../../assets/ui/helpIcon.png"/></a><br/><br/>\
        <% } else { %>\
        Mutation Rate (%): &nbsp;&nbsp;<input data-type="mutationRate" value="<%= mutationRate %>" placeholder="Mutation Rate" class="form-control numberInput" type="text"> <a class="helpModal" data-type="mutationRate" href="#"><img class="helpIcon" src="../../assets/ui/helpIcon.png"/></a><br/><br/>\
        Max Length Change (%): &nbsp;&nbsp;<input data-type="maxLinkChange" value="<%= maxLinkChange %>" placeholder="Max Change" class="form-control numberInput" type="text"> <a class="helpModal" data-type="maxLengthChange" href="#"><img class="helpIcon" src="../../assets/ui/helpIcon.png"/></a><br/><br/>\
        <% } %>\
        Min Link Length: &nbsp;&nbsp;<input data-type="minLinkLength" value="<%= minLinkLength %>" placeholder="Length" class="form-control numberInput" type="text"> <a class="helpModal" data-type="minLinkLength" href="#"><img class="helpIcon" src="../../assets/ui/helpIcon.png"/></a><br/><br/>\
        ...
        Mutate Topology <a class="helpModal" data-type="mutateTopology" href="#"><img class="helpIcon" src="../../assets/ui/helpIcon.png"/></a></label><br/>\
        <% if (mutateTopology){ %>\
            Mutation Options\
        <% } %>\
        ')
